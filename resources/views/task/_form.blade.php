                ...
                <div class="panel-body">
                    ...
                    <form action="{{ url('/tasks') }}" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control datetimepicker" name="start_time" value="{{ old('start_time') }}" placeholder="请输入开工时间" id="start_time">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea class="form-control" value="{{ old('content') }}" placeholder="请输入工作内容" id="content" name="content" cols="50" rows="10"></textarea>
                            </div>
